...
async function sendByeTo(conn, chatId, userId) {
  try {
    ...
    const despedida =
      `👑⚡🌱 ¡Bye bye, ${taguser}! 🌟\n\n` +
      `¡Yotsuba te va a extrañar mucho! 😢 Vuelve pronto para más aventuras y diversión infinita. ¡Genki de mata ne! 🎉\n\n` +
      `> Si extrañas la magia, usa *.menu* para ver mi magia mágica! ✨`
